...
3. Trong Script Properties đặt `CONTENT_SPREADSHEET_ID` và, sau khi booking deploy, `BOOKING_WEB_APP_URL`. Không ghi các giá trị này vào source. Cấu hình ngân hàng và phương thức thanh toán được quản lý trực tiếp tại Admin → Thanh toán.
